...
const PinDescription g_APinDescription[]=
{
  ...
  // 49
  { PORTA,  4, PIO_OUTPUT,     (PIN_ATTR_DIGITAL),                                     No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // W1_ENABLE
  ...
  { PORTA, 5,  PIO_OUTPUT,     (PIN_ATTR_DIGITAL),                                     No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // W2_ENABLE
} ;
