...
const char *key = "[to be defined]"; // INSERT DATA HERE
...
// Operator variables
const char* apn = "[SIMCARDVENDORINFORMATION]"; // DE: iot.1nce.net NL: cdt.iot.t-mobile.nl // INSERT DATA HERE
const char* cdp = "";
unsigned char cid = 1;
const char* forceOperator = "[NETWORKNUMNBER]"; // optional - depends on SIM / network //26201 Telekom Germany 20416 Telekom NL // INSERT DATA HERE
const char band = 8;
...
struct Serverdata{
  ...
  char ip[16];
  uint16_t port;
} server = {false, "[SERVERIP]", [SERVERPORT]}; // INSERT DATA HERE
